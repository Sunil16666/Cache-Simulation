...
public:
    static size_t primitiveGateCount(unsigned cacheLines, unsigned CacheLineSize, unsigned tagBits, unsigned indexBits, bool directMapped) {
        int muxGateCount = tagBits * muxGateCount(cacheLines, indexBits, directMapped);
        int comparatorGateCount = comparatorGateCount(tagBits, directMapped);
    ...
    static int comparatorGateCount(unsigned tagBits, bool directMapped) {
